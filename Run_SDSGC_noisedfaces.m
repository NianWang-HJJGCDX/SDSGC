...
dataname = {'JAFFE_DF_1block','JAFFE_DF_2block','JAFFE_DF_3block','JAFFE_DF_4block','ORL_DF_1block','ORL_DF_2block','ORL_DF_3block','ORL_DF_4block'};
...
result_y_dir = 'Results_ySDSGC_noisedfaces/';
if(~exist('Results_ySDSGC_noisedfaces','file'))
    mkdir('Results_ySDSGC_noisedfaces');
    addpath(genpath('Results_ySDSGC_noisedfaces/'));
end
result_ySDSGC_all_dir = 'Results_ySDSGC_noisedfaces_all/';  
if(~exist('Results_ySDSGC_noisedfaces_all','file'))
    mkdir('Results_ySDSGC_noisedfaces_all');
    addpath(genpath('Results_ySDSGC_noisedfaces_all/'));
end
result_timeSDSGC_dir = 'Results_timeSDSGC_noisedfaces/';
if(~exist('Results_timeSDSGC_noisedfaces','file'))
    mkdir('Results_timeSDSGC_noisedfaces');
    addpath(genpath('Results_timeSDSGC_noisedfaces/'));
end

%% read dataset
for cdata = 1:numdata
disp(char(dataname(cdata)));
datadir = 'our_noised_facedatasets/';
